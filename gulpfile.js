...
gulp.task(
  ...
  gulp.series(function() {
    ...
    gulp.watch(
      ["less/*.less"],
      gulp.series("clean-css", "watch-less", "replace-css")
    );
    gulp.watch(
      ["script/*.js"],
      gulp.series("clean-js", "watch-js", "replace-js")
    );
...
gulp.task(
  "clean-css",
  gulp.series(function() {
    return gulp.src("dist/style/*.css", { read: false }).pipe(clean());
  })
);
gulp.task(
  "clean-js",
  gulp.series(function() {
    return gulp.src("dist/script/*.js", { read: false }).pipe(clean());
  })
);
...
gulp.task(
  "watch-less",
  gulp.series("clean-css", function() {
    return (
      gulp
        .src("less/*.less")
...
gulp.task(
  "replace-css",
  gulp.series("watch-less", function() {
    return gulp
      .src(["dist/rev/*.json", "dist/*.html"])
      .pipe(
        revCollector({
